...
import api.operate.user_pb2 as user__pb2
...
def add_UserServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'api.operate.User', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('api.operate.User', rpc_method_handlers)
