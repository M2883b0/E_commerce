...
import api.ai_agent.ai_agent_pb2 as ai__agent__pb2
...
def add_AiAgentServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UserRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=ai__agent__pb2.UserRequestReq.FromString,
                    response_serializer=ai__agent__pb2.UserRequestResp.SerializeToString,
            ),
    }
