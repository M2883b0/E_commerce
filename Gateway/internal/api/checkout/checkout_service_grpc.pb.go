...
const (
	CheckoutService_Checkout_FullMethodName = "/api.checkout.CheckoutService/Checkout"
)
...
var CheckoutService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.checkout.CheckoutService",
	...
	Metadata: "api/checkout/checkout_service.proto",
}
